About knitty-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/knitty-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6087&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/knitty-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `knitty` can be installed with `conda`:
...
```
mamba install knitty
```

It is possible to list all of the versions of `knitty` available on your platform with `conda`:
...
```
mamba search knitty --channel conda-forge
```
...
mamba repoquery search knitty --channel conda-forge

# List packages depending on `knitty`:
mamba repoquery whoneeds knitty --channel conda-forge

# List dependencies of `knitty`:
mamba repoquery depends knitty --channel conda-forge
```
